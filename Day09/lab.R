...
# What's the difference (other than the random noise) between a single draw of data for these two designs?
...
# in the Southern part of the state won't sample as many units :(

# 3a:
# What is going on in this sampling step?  Why is knowing this
...
# with the estimation procedure we talked about in the slides.
# Examine this function.  Note this is NOT blocked estimation.
...
# This defines our custom estimator.
estimator_weights <- declare_estimator(handler = label_estimator(pate_estimator_func),
                                       label = "weight DIM")
